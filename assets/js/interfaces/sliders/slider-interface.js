...
class SliderInterface extends HTMLElement {
  ...
  setupTableSlider() {
    ...
    const smoothScroll = direction => {
      const maxScrollLeft = cardList.scrollWidth - cardList.clientWidth;
      let targetScroll = direction === "prev" ? cardList.scrollLeft - scrollAmount : cardList.scrollLeft + scrollAmount;
  ...
  setupCardListObserver() {
    this.cardListObserver = new IntersectionObserver(entries => {
      entries.forEach(entry => {
        const target = entry.target;
